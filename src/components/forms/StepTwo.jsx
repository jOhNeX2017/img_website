  ...
  return (
    <div className="animate-fadeIn">
      <div className="mb-6">
        ...
        <p className="text-sm text-gray-400">Help us schedule a call with you</p>
      </div>

      <div className="space-y-4 mb-6">
        <div>
          <label className="block text-sm text-gray-400 mb-2">Mode of Communication *</label>
        ...
        <div>
          <label className="block text-sm text-gray-400 mb-2">Preferred Time of Call *</label>
          <select
            name="preferredTime"
