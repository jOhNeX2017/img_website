                        ...
                        <div className="space-y-3">
                            ...
                            <div>
                                ...
                                <div className="space-y-1.5">
                                    <a href="mailto:info@imoveglobal.org" className="text-gray-400 hover:text-white transition-colors flex items-start gap-2 text-sm group">
                                    ...
                                    <a href="mailto:Ceo@imoveglobal.org" className="text-gray-400 hover:text-white transition-colors flex items-start gap-2 text-sm group">
                                        <svg className="w-4 h-4 flex-shrink-0 mt-0.5 group-hover:text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                                        </svg>
